...
import es.uca.gii.csi16.barbanegra.util.Config;
...
public class Data {
	...
	public static String String2Sql(String s, boolean bAddQuotes, 
	...
	public static int LastId(Connection con) throws Exception {
		...
		try{
			...
			rs = con.createStatement().executeQuery(properties.
